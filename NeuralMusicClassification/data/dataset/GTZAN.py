...
from NeuralMusicClassification.utils.util import pad_along_axis
...
class GTZANDataset(Dataset):
    def __init__(self, cfg, transforms):
        ...
        self.np_samples_address = cfg.DATALOADER.NPY_SAMPLES_TRAINING_DATASET_ADDRESS
        self.np_labels_address = cfg.DATALOADER.NPY_LABELS_TRAINING_DATASET_ADDRESS
