...
def partionDataFrame(df,ratio):
    ...
    train_ds.to_csv("C:/Users/mfran/Desktop/GTZAN/content/new/train.csv", index=False)
    test_ds.to_csv("C:/Users/mfran/Desktop/GTZAN/content/new/test.csv", index=False)
    #train_ds.to_csv("C:/Users/mfran/Desktop/GTZAN/content/new/train_16000.csv",index=False)
    #test_ds.to_csv("C:/Users/mfran/Desktop/GTZAN/content/new/test_16000.csv",index=False)
